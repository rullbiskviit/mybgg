...
function on_render() {
    ...
    var game_details = document.querySelectorAll(".game-details-wrapper");
    game_details.forEach(function(elem) {
        ...
        function close_details(event) {
            elem.parentElement.parentElement.removeAttribute("open");
        }
...
function init(SETTINGS) {
    ...
    const search = instantsearch({
        ...
        searchClient: algoliasearch(SETTINGS.algolia.app_id, SETTINGS.algolia.api_key_search_only),
        routing: true
    });
